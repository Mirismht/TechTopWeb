...
const handleSubmit = (e)=>{
    ...
    if (name.trim() === "" || email.trim() === "" || phone.trim() === "" || website.trim() === "" || message.trim() === "") {
...
whatsappLink.addEventListener("click", redirectToWhatsApp); //comment for the code  we define a JavaScript function called redirectToWhatsApp(). Inside the function, we set the phoneNumber variable to your actual WhatsApp number, including the country code.
...
//# sourceMappingURL=index.00e639aa.js.map
